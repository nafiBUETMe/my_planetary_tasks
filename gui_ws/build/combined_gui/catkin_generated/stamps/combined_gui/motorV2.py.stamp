...
def update_color(color):
    header_label["background"] = "blue"
    devicelist_label["background"] = "cyan"
    stats_label["background"] = "hot pink"
    terminal_label["background"] = "red"
    arm_label["background"] = color
    actions_label["background"] = "magenta"
...
arm_label = ttk.Label(arm_frame, text='Science Testing', borderwidth=2, relief="solid", background=background_color.get(), anchor=tk.CENTER, font=(global_font.get(), 12, 'bold'))
base_label = ttk.Label(arm_frame, text='N@fi ', font=(global_font.get(), 10))
